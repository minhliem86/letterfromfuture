@if($date_more)
  @foreach($date_more as $item_more)
  <div class="each-baiduthi">
    <div class="wrap-bai">
      ...
      <a href="#"><img src="{!!$item_more->fb_img!!}" class="img-responsive" alt=""></a>
      <div class="overlay">
...
<div class="wrap-more-content baithi-more">
  <a href="#" id="xemthem_baiduthi" class="btn-me btn-showmore" data-date='{!!$date_more->updated_at!!}'>Xem thêm</a>
</div>
@else
