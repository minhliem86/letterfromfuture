...
<div class="section login mypost">
			<div class="container">
				<div class="row">
					<div class="inner-login">
						<div class="wrap-login">
							<form action="{!!route('frontend.postDangnhaphocvien')!!}" class="form-login" method="POST">
								{!!Form::token()!!}
								...
								<div class="wrap-btn clearfix">
									<input type="submit" class="btn-login-mypost" value="Đăng nhập" >
